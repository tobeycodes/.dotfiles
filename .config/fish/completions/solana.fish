...
complete -c solana -n "__fish_use_subcommand" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_use_subcommand" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_use_subcommand" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_use_subcommand" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_use_subcommand" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_use_subcommand" -f -a "recent-prioritization-fees" -d 'Get recent prioritization fees'
...
complete -c solana -n "__fish_use_subcommand" -f -a "rent" -d 'Calculate rent-exempt-minimum value for a given account data field length.'
...
complete -c solana -n "__fish_use_subcommand" -f -a "upgrade-nonce-account" -d 'One-time idempotent upgrade of legacy nonce versions in order to bump them out of chain blockhash domain.'
complete -c solana -n "__fish_use_subcommand" -f -a "program" -d 'Program management'
complete -c solana -n "__fish_use_subcommand" -f -a "deploy" -d 'Deploy has been removed. Use `solana program deploy` instead to deploy upgradeable programs'
complete -c solana -n "__fish_use_subcommand" -f -a "program-v4" -d 'Program V4 management'
complete -c solana -n "__fish_use_subcommand" -f -a "address-lookup-table" -d 'Address lookup table management'
...
complete -c solana -n "__fish_use_subcommand" -f -a "redelegate-stake"
...
complete -c solana -n "__fish_use_subcommand" -f -a "stake-minimum-delegation" -d 'Get the stake minimum delegation amount'
...
complete -c solana -n "__fish_use_subcommand" -f -a "create-address-with-seed" -d 'Generate a derived account address with a seed. For program derived addresses (PDAs), use the find-program-derived-address command instead'
complete -c solana -n "__fish_use_subcommand" -f -a "find-program-derived-address" -d 'Generate a program derived account address with a seed'
...
complete -c solana -n "__fish_use_subcommand" -f -a "sign-offchain-message" -d 'Sign off-chain message'
complete -c solana -n "__fish_use_subcommand" -f -a "verify-offchain-signature" -d 'Verify off-chain message signature'
...
complete -c solana -n "__fish_seen_subcommand_from block" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from block" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from block" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l limit-num-slots -d 'Limit the number of slots to the last <N> slots'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from recent-prioritization-fees" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from catchup" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from catchup" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from catchup" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from catchup" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from catchup" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from cluster-date" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from cluster-date" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from cluster-date" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from cluster-date" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from cluster-date" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from cluster-version" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from cluster-version" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from cluster-version" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from cluster-version" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from cluster-version" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from first-available-block" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from first-available-block" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from first-available-block" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from first-available-block" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from first-available-block" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from block-time" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from block-time" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from block-time" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-time" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-time" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from leader-schedule" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from leader-schedule" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from leader-schedule" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from leader-schedule" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from leader-schedule" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from epoch-info" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from epoch-info" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from epoch-info" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from epoch-info" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from epoch-info" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from genesis-hash" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from genesis-hash" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from genesis-hash" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from genesis-hash" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from genesis-hash" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from slot" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from slot" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from slot" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from slot" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from slot" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from block-height" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from block-height" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from block-height" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-height" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-height" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from epoch" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from epoch" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from epoch" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from epoch" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from epoch" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from largest-accounts" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from largest-accounts" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from largest-accounts" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from largest-accounts" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from largest-accounts" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from supply" -l print-accounts -d 'Print list of non-circulating account addresses'
...
complete -c solana -n "__fish_seen_subcommand_from supply" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from supply" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from supply" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from supply" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from supply" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from total-supply" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from total-supply" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from total-supply" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from total-supply" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from total-supply" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from transaction-count" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from transaction-count" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from transaction-count" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transaction-count" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transaction-count" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from ping" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from ping" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from ping" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from ping" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from ping" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from ping" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from live-slots" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from live-slots" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from live-slots" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from live-slots" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from live-slots" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from logs" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from logs" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from logs" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from logs" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from logs" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from block-production" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from block-production" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from block-production" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-production" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from block-production" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from gossip" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from gossip" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from gossip" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from gossip" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from gossip" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stakes" -l withdraw-authority -d 'Only show stake accounts with the provided withdraw authority. Address is one of:
...
complete -c solana -n "__fish_seen_subcommand_from stakes" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stakes" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stakes" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stakes" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stakes" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from validators" -l sort -d 'Sort order (does not affect JSON output)' -r -f -a "delinquent commission credits identity last-vote root skip-rate stake version vote-account"
...
complete -c solana -n "__fish_seen_subcommand_from validators" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from validators" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from validators" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from validators" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from validators" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -l until -d 'List until this transaction signature, if found before limit reached'
...
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transaction-history" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from wait-for-max-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from wait-for-max-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from wait-for-max-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from wait-for-max-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from wait-for-max-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from rent" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from rent" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from rent" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from rent" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from rent" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from feature" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from feature" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from feature" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from feature" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from feature" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from feature" -f -a "revoke" -d 'Revoke a pending runtime feature'
...
complete -c solana -n "__fish_seen_subcommand_from status" -l display-all -d 'display all features regardless of age'
...
complete -c solana -n "__fish_seen_subcommand_from status" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from status" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from status" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from status" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from status" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from activate" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword 
...
complete -c solana -n "__fish_seen_subcommand_from activate" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from activate" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from activate" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from activate" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from activate" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from revoke" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword 
or the pubkey of an offline signer, provided an appropriate --signer argument 
is also passed. Defaults to the client keypair.'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from revoke" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from revoke" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from revoke" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from revoke" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from help" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from help" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from help" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from help" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from inflation" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from inflation" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from inflation" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from inflation" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from inflation" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from rewards" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from rewards" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from rewards" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from rewards" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from rewards" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from authorize-nonce-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l nonce-authority -d 'Assign noncing authority to this other entity. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-nonce-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from nonce" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from nonce" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from nonce" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from nonce" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from nonce" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from new-nonce" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from nonce-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from nonce-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from nonce-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from nonce-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from nonce-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-nonce-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l with-memo -d 'Specify a memo string to include in the transaction.'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from upgrade-nonce-account" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from program" -l skip-fee-check
...
complete -c solana -n "__fish_seen_subcommand_from program" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from program" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from program" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from program" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from program" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from program" -f -a "deploy" -d 'Deploy an upgradeable program'
complete -c solana -n "__fish_seen_subcommand_from program" -f -a "upgrade" -d 'Upgrade an upgradeable program'
...
complete -c solana -n "__fish_seen_subcommand_from program" -f -a "extend" -d 'Extend the length of an upgradeable program to deploy larger programs'
complete -c solana -n "__fish_seen_subcommand_from program" -f -a "migrate" -d 'Migrates an upgradeable program to loader-v4'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword 
or the pubkey of an offline signer, provided an appropriate --signer argument 
is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l program-id -d 'Executable program; must be a signer for initial deploys, can be an address for upgrades [default: address of keypair at /path/to/program-keypair.json if present, otherwise a random address]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
  * a hardware wallet keypair URL (i.e. usb://ledger)'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l max-len -d 'Maximum length of the upgradeable program [default: the length of the original deployed program]'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l max-sign-attempts -d 'Maximum number of attempts to sign or resign transactions after blockhash expiration. If any transactions sent during the program deploy are still unconfirmed after the initially chosen recent blockhash expires, those transactions will be resigned with a new recent blockhash and resent. Use this setting to adjust the maximum number of transaction signing iterations. Each blockhash is valid for about 60 seconds, which means using the default value of 5 will lead to sending transactions for at least 5 minutes or until all transactions are confirmed,whichever comes first.'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l allow-excessive-deploy-account-balance -d 'Use the designated program id even if the account already holds a large balance of SOL (Obsolete)'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l use-rpc -d 'Send write transactions to the configured RPC instead of validator TPUs'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l no-auto-extend -d 'Don\'t automatically extend the program\'s data account size'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-feature-verify -d 'Don\'t verify program against the activated feature set. This setting means a program containing a syscall not yet active on mainnet will succeed local verification, but fail during the last step of deployment.'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword 
or the pubkey of an offline signer, provided an appropriate --signer argument 
is also passed. Defaults to the client keypair.'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l upgrade-authority -d 'Upgrade authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l blockhash -d 'Use the supplied blockhash'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l signer -d 'Provide a public-key/signature pair for the transaction'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l skip-feature-verify -d 'Don\'t verify program against the activated feature set. This setting means a program containing a syscall not yet active on mainnet will succeed local verification, but fail during the last step of deployment.'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from upgrade" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l fee-payer -d 'Specify the fee-payer account. This may be a keypair file, the ASK keyword 
or the pubkey of an offline signer, provided an appropriate --signer argument 
is also passed. Defaults to the client keypair.'
...
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l max-len -d 'Maximum length of the upgradeable program [default: the length of the original deployed program]'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l max-sign-attempts -d 'Maximum number of attempts to sign or resign transactions after blockhash expiration. If any transactions sent during the program deploy are still unconfirmed after the initially chosen recent blockhash expires, those transactions will be resigned with a new recent blockhash and resent. Use this setting to adjust the maximum number of transaction signing iterations. Each blockhash is valid for about 60 seconds, which means using the default value of 5 will lead to sending transactions for at least 5 minutes or until all transactions are confirmed,whichever comes first.'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l use-rpc -d 'Send transactions to the configured RPC instead of validator TPUs'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l skip-feature-verify -d 'Don\'t verify program against the activated feature set. This setting means a program containing a syscall not yet active on mainnet will succeed local verification, but fail during the last step of deployment.'
...
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from write-buffer" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l new-buffer-authority -d 'New buffer authority. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set-buffer-authority" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l skip-new-upgrade-authority-signer-check -d 'Set this flag if you don\'t want the new authority to sign the set-upgrade-authority transaction.'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
...
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set-upgrade-authority" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from show" -l buffer-authority -d 'Authority [default: the default configured keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from show" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from show" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from show" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from show" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from show" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from show" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from dump" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from dump" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from dump" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from dump" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from dump" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from dump" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from close" -l recipient -d 'Recipient of closed account\'s lamports [default: the default configured keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from close" -l bypass-warning -d 'Bypass the permanent program closure warning'
...
complete -c solana -n "__fish_seen_subcommand_from close" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from close" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from close" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from close" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from close" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from close" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from extend" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from extend" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from extend" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from extend" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from extend" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from extend" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from extend" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from extend" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from extend" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from extend" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from extend" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from extend" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from extend" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from extend" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from extend" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from extend" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from extend" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from extend" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l authority -d 'Upgrade authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from migrate" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from migrate" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from migrate" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from migrate" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from migrate" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from help" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from help" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from help" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from help" -s k -l keypair -d 'Filepath or URL to a keypair'
...
complete -c solana -n "__fish_seen_subcommand_from help" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from help" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-fee-check
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from help" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from help" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from help" -l use-udp -d 'Use UDP when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "deploy" -d 'Deploy a new or redeploy an existing program'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "retract" -d 'Reverse deployment or close a program entirely'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "transfer-authority" -d 'Transfer the authority of a program to a different address'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "finalize" -d 'Finalize a program to make it immutable'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "show" -d 'Display information about a buffer or program'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "download" -d 'Download the executable of a program to a file'
complete -c solana -n "__fish_seen_subcommand_from program-v4" -f -a "help" -d 'Prints this message or the help of the given subcommand(s)'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l start-offset -d 'Optionally starts writing at this byte offset'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l end-offset -d 'Optionally stops writing after this byte offset'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l program-keypair -d 'Program account signer for deploying a new program'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l program-id -d 'Program address for redeploying an existing program'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l buffer -d 'Optional intermediate buffer account to write data to'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l authority -d 'Program authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l blockhash -d 'Use the supplied blockhash'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l signer -d 'Provide a public-key/signature pair for the transaction'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l ws -d 'WebSocket URL for the solana cluster'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l use-rpc -d 'Send transactions to the configured RPC instead of validator TPUs'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from deploy" -s v -l verbose -d 'Show additional information'
...
complete -c solana -n "__fish_seen_subcommand_from deploy" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from deploy" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from retract" -l program-id -d 'Executable program\'s address'
complete -c solana -n "__fish_seen_subcommand_from retract" -l authority -d 'Program authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from retract" -l blockhash -d 'Use the supplied blockhash'
complete -c solana -n "__fish_seen_subcommand_from retract" -l signer -d 'Provide a public-key/signature pair for the transaction'
complete -c solana -n "__fish_seen_subcommand_from retract" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from retract" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from retract" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from retract" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from retract" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from retract" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from retract" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from retract" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from retract" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from retract" -l close-program-entirely -d 'Reset the program account and retrieve its funds'
complete -c solana -n "__fish_seen_subcommand_from retract" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from retract" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
complete -c solana -n "__fish_seen_subcommand_from retract" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from retract" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from retract" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from retract" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from retract" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from retract" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from retract" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from retract" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from retract" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l program-id -d 'Executable program\'s address'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l authority -d 'Current program authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l new-authority -d 'New program authority'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l blockhash -d 'Use the supplied blockhash'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l signer -d 'Provide a public-key/signature pair for the transaction'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from transfer-authority" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l program-id -d 'Executable program\'s address'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l authority -d 'Program authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l next-version -d 'Reserves the address and links it as the programs next-version, which is a hint that frontends can show to users'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l blockhash -d 'Use the supplied blockhash'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l signer -d 'Provide a public-key/signature pair for the transaction'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from finalize" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from finalize" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l sign-only -d 'Sign the transaction offline'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l dump-transaction-message -d 'Display the base64 encoded binary transaction message in sign-only mode'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from finalize" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from finalize" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from show" -l program-id -d 'Executable program\'s address'
complete -c solana -n "__fish_seen_subcommand_from show" -l authority -d 'Authority [default: the default configured keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from show" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from show" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from download" -l program-id -d 'Executable program\'s address'
complete -c solana -n "__fish_seen_subcommand_from download" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from download" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from download" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from download" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from download" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from download" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from download" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from download" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from download" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from download" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from download" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from download" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from download" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from download" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from download" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from download" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from download" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from help" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from help" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from help" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from help" -s k -l keypair -d 'Filepath or URL to a keypair'
...
complete -c solana -n "__fish_seen_subcommand_from help" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "create" -d 'Create a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "freeze" -d 'Permanently freezes a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "extend" -d 'Append more addresses to a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "deactivate" -d 'Permanently deactivates a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "close" -d 'Permanently closes a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "get" -d 'Display information about a lookup table'
complete -c solana -n "__fish_seen_subcommand_from address-lookup-table" -f -a "help" -d 'Prints this message or the help of the given subcommand(s)'
complete -c solana -n "__fish_seen_subcommand_from create" -l authority -d 'Lookup table authority address [default: the default configured keypair].'
complete -c solana -n "__fish_seen_subcommand_from create" -l payer -d 'Account that will pay rent fees for the created lookup table [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from create" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from create" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from create" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from create" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from create" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from create" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from create" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from create" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from create" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from create" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from create" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from create" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l authority -d 'Lookup table authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from freeze" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from freeze" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l bypass-warning -d 'Bypass the permanent lookup table freeze warning'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from freeze" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from freeze" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from extend" -l authority -d 'Lookup table authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from extend" -l payer -d 'Account that will pay rent fees for the extended lookup table [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from extend" -l addresses -d 'Comma separated list of addresses to append'
complete -c solana -n "__fish_seen_subcommand_from extend" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from extend" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from extend" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from extend" -s k -l keypair -d 'Filepath or URL to a keypair'
...
complete -c solana -n "__fish_seen_subcommand_from extend" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from extend" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l authority -d 'Lookup table authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l bypass-warning -d 'Bypass the permanent lookup table deactivation warning'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from deactivate" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from close" -l recipient -d 'Address of the recipient account to deposit the closed account\'s lamports [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from close" -l authority -d 'Lookup table authority [default: the default configured keypair]'
complete -c solana -n "__fish_seen_subcommand_from close" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from close" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from close" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from close" -s k -l keypair -d 'Filepath or URL to a keypair'
...
complete -c solana -n "__fish_seen_subcommand_from get" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from get" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from get" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from get" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from get" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from help" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from help" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l custodian -d 'Authority to modify lockups. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-stake-account-checked" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from delegate-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from redelegate-stake" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l new-stake-authority -d 'New authorized staker. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
  * a hardware wallet keypair URL (i.e. usb://ledger)'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l new-withdraw-authority -d 'New authorized withdrawer. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-authorize-checked" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l delinquent -d 'Deactivate abandoned stake that is currently delegated to a delinquent vote account'
...
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from deactivate-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l rent-exempt-reserve-sol -d 'The rent-exempt amount to move into the new stake account, in SOL. Required for offline signing.'
...
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from split-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from split-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from merge-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-stake" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l new-custodian -d 'New lockup custodian. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-set-lockup-checked" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l starting-epoch -d 'Start displaying from epoch NUM'
...
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l csv -d 'Format stake rewards data in csv'
...
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-history" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-history" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-history" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-history" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-history" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l lamports -d 'Display minimum delegation in lamports instead of SOL'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from stake-minimum-delegation" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from validator-info" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from validator-info" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from validator-info" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from validator-info" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from validator-info" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from publish" -s i -l icon-url -d 'Validator icon URL'
...
complete -c solana -n "__fish_seen_subcommand_from publish" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from publish" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from publish" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from publish" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from publish" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from publish" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l authorized-voter -d 'Authorized voter [default: validator identity pubkey]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-vote-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-voter-checked" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l skip-preflight -d 'Skip the preflight check when sending transactions'
...
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-authorize-withdrawer-checked" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-update-validator" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-update-commission" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l starting-epoch -d 'Start displaying from epoch NUM'
...
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l csv -d 'Format rewards in a CSV table'
...
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from vote-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from vote-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from withdraw-from-vote-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from close-vote-account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from account" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from account" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from account" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from account" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from account" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from address" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from address" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from address" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from address" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from address" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from airdrop" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from airdrop" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from airdrop" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from airdrop" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from airdrop" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from balance" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from balance" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from balance" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from balance" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from balance" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from confirm" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from confirm" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from confirm" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from confirm" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from confirm" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -l from -d 'From (base) key, [default: cli config keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from create-address-with-seed" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s V -l version -d 'Prints version information'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from find-program-derived-address" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from decode-transaction" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from decode-transaction" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from decode-transaction" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from decode-transaction" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from decode-transaction" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from resolve-signer" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from resolve-signer" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from resolve-signer" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from resolve-signer" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from resolve-signer" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from transfer" -l from -d 'Source account of funds [default: cli config keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
...
or the pubkey of an offline signer, provided an appropriate --signer argument 
is also passed. Defaults to the client keypair.'
complete -c solana -n "__fish_seen_subcommand_from transfer" -l with-compute-unit-price -d 'Set compute unit price for transaction, in increments of 0.000001 lamports per compute unit.'
...
complete -c solana -n "__fish_seen_subcommand_from transfer" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from transfer" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from transfer" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transfer" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from transfer" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l version -d 'The off-chain message version'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from sign-offchain-message" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l version -d 'The off-chain message version'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l signer -d 'Message signer [default: cli config keypair]. Address is one of:
  * a base58-encoded public key
  * a path to a keypair file
  * a hyphen; signals a JSON-encoded keypair on stdin
  * the \'ASK\' keyword; to recover a keypair via its seed phrase
  * a hardware wallet keypair URL (i.e. usb://ledger)'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -s C -l config -d 'Configuration file to use'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -s u -l url -d 'URL for Solana\'s JSON RPC or moniker (or their first letter): [mainnet-beta, testnet, devnet, localhost]'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l ws -d 'WebSocket URL for the solana cluster'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -s k -l keypair -d 'Filepath or URL to a keypair'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l commitment -d 'Return information at the selected commitment level [possible values: processed, confirmed, finalized]' -r -f -a "processed confirmed finalized recent single singleGossip root max"
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l output -d 'Return information in specified output format' -r -f -a "json json-compact"
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l rpc-timeout -d 'Timeout value for RPC requests'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l confirm-timeout -d 'Timeout value for initial transaction status'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -s h -l help -d 'Prints help information'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l use-tpu-client -d 'Use TPU client when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l no-address-labels -d 'Do not use address labels in the output'
complete -c solana -n "__fish_seen_subcommand_from verify-offchain-signature" -l skip-seed-phrase-validation -d 'Skip validation of seed phrases. Use this if your phrase does not use the BIP39 official English word list'
...
complete -c solana -n "__fish_seen_subcommand_from config" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from config" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from config" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from config" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from config" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from set" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from set" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from set" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from set" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from import-address-labels" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from import-address-labels" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from import-address-labels" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from import-address-labels" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from import-address-labels" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from export-address-labels" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from export-address-labels" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from export-address-labels" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from export-address-labels" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from export-address-labels" -l use-tpu-client -d 'Use TPU client when sending transactions.'
...
complete -c solana -n "__fish_seen_subcommand_from completion" -l skip-preflight -d 'Skip the preflight check when sending transactions'
complete -c solana -n "__fish_seen_subcommand_from completion" -s v -l verbose -d 'Show additional information'
complete -c solana -n "__fish_seen_subcommand_from completion" -l use-quic -d 'Use QUIC when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from completion" -l use-udp -d 'Use UDP when sending transactions.'
complete -c solana -n "__fish_seen_subcommand_from completion" -l use-tpu-client -d 'Use TPU client when sending transactions.'
